...
enum CaptureQuality: String, CaseIterable, Sendable, Identifiable {
    case precise   // 120fps
    case standard  // 60fps
...
enum ExposureSetting: String, CaseIterable, Sendable, Identifiable {
    case auto
...
struct CMTimeValueSpec: Sendable, Equatable {
    let numerator: Int32
...
enum DistancePreset: Double, CaseIterable, Sendable, Identifiable {
    case near = 5
    case recommended = 6
    case far = 8

    var id: Double { rawValue }
    var title: String { "\(Int(rawValue))m" }
}
